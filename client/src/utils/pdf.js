...
export async function htmlToPdfBlob(html) {
  // Choose dimensions for A4 portrait at ~96dpi
  ...
  // Center certificate content for portrait (keep margins consistent)
  try {
  ...
  const pdf = new jsPDF({ unit: 'px', format: [dims.width, dims.height] });
